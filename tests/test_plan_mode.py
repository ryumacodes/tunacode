...
from tunacode.cli.commands.implementations.plan import PlanCommand, ExitPlanCommand
...
class TestToolHandler:
    ...
    def test_should_confirm_in_plan_mode(self):
        ...
        assert not tool_handler.should_confirm("read_file")  # Read-only tools don't need confirmation
