# Context for: subprocess-shell-security-vulnerabilities
_Started: 2025-06-24 22:03:19_

---
### Contents of \`../src/tunacode/tools/run_command.py\`
```
"""
...
---
### Contents of \`../src/tunacode/cli/repl.py\`
```
"""
...
---
### \`grep -n 'subprocess\ < /dev/null | shell=True' ../src/tunacode/tools/run_command.py ../src/tunacode/cli/repl.py\`
```
---
### \`echo 'Security vulnerability analysis of subprocess.run with shell=True usage'\`
```
