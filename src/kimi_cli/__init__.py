...
def kimi(
    ...
    agent = load_agent(agent_path) if agent_path else load_agent_by_name(_DEFAULT_AGENT_NAME)
    if agent is None:
        raise click.ClickException(f"Agent not found: {agent_path}")
