...
class ModelSelector:
    ...
    def _build_model_info(self) -> List[ModelInfo]:
        ...
        model_metadata = {
            # Anthropic models
            "anthropic:claude-opus-4-20250514": ("Claude Opus 4", "opus-4", "Most capable Claude model", "high"),
            "anthropic:claude-sonnet-4-20250514": ("Claude Sonnet 4", "sonnet-4", "Balanced performance", "medium"),
            "anthropic:claude-3-7-sonnet-latest": ("Claude 3.7 Sonnet", "sonnet-3.7", "Previous generation", "medium"),
            
            # Google models
            "google-gla:gemini-2.0-flash": ("Gemini 2.0 Flash", "flash-2.0", "Fast and efficient", "low"),
            "google-gla:gemini-2.5-flash-preview-05-20": ("Gemini 2.5 Flash", "flash-2.5", "Latest preview", "low"),
            "google-gla:gemini-2.5-pro-preview-05-06": ("Gemini 2.5 Pro", "pro-2.5", "Most capable Gemini", "medium"),
            ...
            # OpenRouter models
            "openrouter:mistralai/devstral-small": ("Devstral Small", "devstral", "Code-focused", "low"),
            ...
            "openrouter:openai/gpt-4.1": ("GPT-4.1 (OR)", "gpt-4.1-or", "GPT-4.1 via OpenRouter", "medium"),
            "openrouter:openai/gpt-4.1-mini": ("GPT-4.1 Mini (OR)", "4.1-mini-or", "GPT-4.1 Mini via OpenRouter", "low"),
        }
