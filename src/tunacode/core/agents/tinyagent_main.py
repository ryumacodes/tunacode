...
from tunacode.tools.tinyagent_tools import read_file, write_file, update_file, run_command
from tunacode.types import ModelName, AgentRun, ToolCallback
    ...
    if model not in agents:
        ...
        if model.startswith("openrouter:"):
            ...
            if state_manager.session.user_config["env"].get("OPENROUTER_API_KEY"):
                os.environ["OPENAI_API_KEY"] = state_manager.session.user_config["env"]["OPENROUTER_API_KEY"]
        else:
